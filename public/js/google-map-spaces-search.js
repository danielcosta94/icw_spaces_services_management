$(function () {
    ...
    function callback(data_key, marker, map) {
    ...
    function addSpaceMarkers(map) {
        ...
        if (space_type.value == "all") {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for(var data_space in data_spaces) {
                        ...
                        geocoder.geocode({'latLng': new google.maps.LatLng(gps_points[0], gps_points[1])}, callback(data_key, marker, map));
                    }
                }
            ...
            $.ajax({
                type: "GET",
                data: {space_type_id: space_type.value},
                dataType: 'json',
                url: "../spaces_visible",
                success: function (data) {
        ...
        $("#city").change(function() {
            if(city.value != "") {
                ...
                var location = new google.maps.LatLng(41.1407459, -8.6105732);
