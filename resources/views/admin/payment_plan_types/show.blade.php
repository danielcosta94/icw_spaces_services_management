            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">{{ trans('management.view') . ' ' . trans('management.payment_plan_types') }}</div>
                        <div class="panel-body">
                            <div class="form-horizontal">
                                
                                <div>
                                    <label class="col-md-4 control-label text-right">{{ trans('management.plan_type') }}</label>

                                    <div class="col-md-5">
                                        <p class="form-control">{{$payment_plan_type->plan}}</p>
                                    </div>
                                </div>

                                <div>
                                    <div class="col-md-6 col-md-offset-4">
                                        <a href="{{ route('payment_plan_types.edit', $payment_plan_type) }}" class="btn btn-warning" role="button">{{ trans('management.edit') }}</a>
