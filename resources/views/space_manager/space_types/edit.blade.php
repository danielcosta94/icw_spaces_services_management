            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">{{ trans('management.edit') . ' ' . trans_choice('management_spaces.space_type', 1) }}</div>
                        <div class="panel-body">
                            {!! Form::open(['class' => 'form-horizontal', 'role' => 'form', 'method' => 'PUT', 'route' => ['space_types.update', $space_type->id]]) !!}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('space_type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <input id="space_type" type="text" class="form-control" name="space_type" value="{{$space_type->space_type}}" required>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <textarea id="description" type="text" class="form-control text_height" name="description" required>{{$space_type->description}}</textarea>
