            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">{{ trans('management.view') . ' ' . trans_choice('management_spaces.space_type', 1) }}</div>
                        <div class="panel-body">
                            <div class="form-horizontal">
                                ...
                                <div>
                                    ...
                                    <div class="col-md-7">
                                        <p class="form-control">{{$space_type->space_type}}</p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="col-md-7 padding-bottom-text">
                                        <div class="padding-text">{{$space_type->description}}</div>
                                    </div>
                                </div>

                                <div>
                                    <div class="col-md-6 col-md-offset-4">
                                        <a href="{{ route('space_types.edit', $space_type) }}" class="btn btn-warning" role="button">{{ trans('management.edit') }}</a>
